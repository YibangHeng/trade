...
TEST_CASE("Market data checking", "[MdValidator]")
{
    ...
    l2_tick_0->set_price_1000x(2233);
    ...
    l2_tick_2->set_price_1000x(2233);
    ...
    l2_tick_3->set_price_1000x(2233);
    ...
    SECTION("Checking via trade tick")
    {
        ...
        trade_tick_0->set_exec_price_1000x(2233);
        ...
        trade_tick_1->set_exec_price_1000x(2233);
        ...
        trade_tick_2->set_exec_price_1000x(2233);
        ...
        trade_tick_3->set_exec_price_1000x(2233);
        ...
        trade_tick_4->set_exec_price_1000x(2233);
