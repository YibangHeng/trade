...
public:
	...
	///设置Onload信息;不设置则不使用onload
	///pInterface网卡名;如enp23s0f0
	///pLocalAddress本地地址;如udp://1.1.1.1:8888,说明传输协议是udp,ip地址是1.1.1.1，端口号是8888
	///pRemoteAddress远端地址;如udp://1.1.1.2:8888,说明传输协议是udp,ip地址是1.1.1.2，端口号是8888
	virtual void RegisterOnloadInfo(const char *pInterface, const char* pLocalAddress, const char* pRemoteAddress) = 0;
