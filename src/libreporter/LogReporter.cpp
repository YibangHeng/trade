...
void trade::reporter::LogReporter::exchange_tick_arrived(const std::shared_ptr<types::ExchangeTick> exchange_tick)
{
    md_logger->debug("Exchange tick arrived: {}", utilities::ToJSON()(*exchange_tick));
