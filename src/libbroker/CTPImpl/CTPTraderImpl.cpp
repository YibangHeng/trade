...
void trade::broker::CTPTraderImpl::new_order(
...
)
{
    ...
    if (code != 0) {
        ...
        new_order_rsp->set_rejection_reason("CTP API returned with code {}", code);
...
void trade::broker::CTPTraderImpl::cancel_order(
