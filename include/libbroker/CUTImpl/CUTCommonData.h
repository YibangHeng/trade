...
public:
    ...
    [[nodiscard]] static booker::L2TickPtr to_exchange_l2_tick(const std::vector<u_char>& message);
...
template<>
inline booker::L2TickPtr CUTCommonData::to_exchange_l2_tick<SSEHpfL2Snap>(const std::vector<u_char>& message)
{
    ...
    l2_tick->set_price(raw_l2_tick->m_last_price / 1000.);
    l2_tick->set_quantity(to_quantity_from_sse(raw_l2_tick->m_trade_volume));

    l2_tick->set_pre_settlement(raw_l2_tick->m_prev_close);
    l2_tick->set_pre_close_price(raw_l2_tick->m_prev_close);
    l2_tick->set_open_price(raw_l2_tick->m_open_price);
    l2_tick->set_highest_price(raw_l2_tick->m_day_high);
    l2_tick->set_lowest_price(raw_l2_tick->m_day_low);
    l2_tick->set_close_price(raw_l2_tick->m_last_price);
    l2_tick->set_settlement_price(raw_l2_tick->m_close_price);
    l2_tick->set_upper_limit_price(raw_l2_tick->m_last_price * 1.1 / 1000.);
    l2_tick->set_lower_limit_price(raw_l2_tick->m_last_price * 0.9 / 1000.);

    l2_tick->set_sell_price_1(raw_l2_tick->m_ask_px[0].m_px / 1000.);
    l2_tick->set_sell_quantity_1(to_quantity_from_sse(raw_l2_tick->m_ask_px[0].m_qty));
    l2_tick->set_sell_price_2(raw_l2_tick->m_ask_px[1].m_px / 1000.);
    l2_tick->set_sell_quantity_2(to_quantity_from_sse(raw_l2_tick->m_ask_px[1].m_qty));
    l2_tick->set_sell_price_3(raw_l2_tick->m_ask_px[2].m_px / 1000.);
    l2_tick->set_sell_quantity_3(to_quantity_from_sse(raw_l2_tick->m_ask_px[2].m_qty));
    l2_tick->set_sell_price_4(raw_l2_tick->m_ask_px[3].m_px / 1000.);
    l2_tick->set_sell_quantity_4(to_quantity_from_sse(raw_l2_tick->m_ask_px[3].m_qty));
    l2_tick->set_sell_price_5(raw_l2_tick->m_ask_px[4].m_px / 1000.);
    l2_tick->set_sell_quantity_5(to_quantity_from_sse(raw_l2_tick->m_ask_px[4].m_qty));

    l2_tick->set_buy_price_1(raw_l2_tick->m_bid_px[0].m_px / 1000.);
    l2_tick->set_buy_quantity_1(to_quantity_from_sse(raw_l2_tick->m_bid_px[0].m_qty));
    l2_tick->set_buy_price_2(raw_l2_tick->m_bid_px[1].m_px / 1000.);
    l2_tick->set_buy_quantity_2(to_quantity_from_sse(raw_l2_tick->m_bid_px[1].m_qty));
    l2_tick->set_buy_price_3(raw_l2_tick->m_bid_px[2].m_px / 1000.);
    l2_tick->set_buy_quantity_3(to_quantity_from_sse(raw_l2_tick->m_bid_px[2].m_qty));
    l2_tick->set_buy_price_4(raw_l2_tick->m_bid_px[3].m_px / 1000.);
    l2_tick->set_buy_quantity_4(to_quantity_from_sse(raw_l2_tick->m_bid_px[3].m_qty));
    l2_tick->set_buy_price_5(raw_l2_tick->m_bid_px[4].m_px / 1000.);
...
template<>
inline booker::L2TickPtr CUTCommonData::to_exchange_l2_tick<SZSEHpfL2Snap>(const std::vector<u_char>& message)
{
    auto l2_tick = std::make_shared<types::L2Tick>();
    ...
    l2_tick->set_price(raw_l2_tick->m_last_price / 10000.);
    l2_tick->set_quantity(to_quantity_from_szse(raw_l2_tick->m_total_quantity_trade));

    l2_tick->set_pre_settlement(raw_l2_tick->m_previous_close_price / 10000.);
    l2_tick->set_pre_close_price(raw_l2_tick->m_previous_close_price / 10000.);
    l2_tick->set_open_price(raw_l2_tick->m_open_price / 10000.);
    l2_tick->set_highest_price(raw_l2_tick->m_day_high / 10000.);
    l2_tick->set_lowest_price(raw_l2_tick->m_day_low / 10000.);
    l2_tick->set_close_price(raw_l2_tick->m_today_close_price / 10000.);
    l2_tick->set_settlement_price(raw_l2_tick->m_today_close_price / 10000.);
    l2_tick->set_upper_limit_price(raw_l2_tick->m_upper_limit_price / 10000.);
    l2_tick->set_lower_limit_price(raw_l2_tick->m_lower_limit_price / 10000.);

    l2_tick->set_sell_price_1(raw_l2_tick->m_ask_unit[0].m_price / 10000.);
    l2_tick->set_sell_quantity_1(to_quantity_from_szse(raw_l2_tick->m_ask_unit[0].m_qty));
    l2_tick->set_sell_price_2(raw_l2_tick->m_ask_unit[1].m_price / 10000.);
    l2_tick->set_sell_quantity_2(to_quantity_from_szse(raw_l2_tick->m_ask_unit[1].m_qty));
    l2_tick->set_sell_price_3(raw_l2_tick->m_ask_unit[2].m_price / 10000.);
    l2_tick->set_sell_quantity_3(to_quantity_from_szse(raw_l2_tick->m_ask_unit[2].m_qty));
    l2_tick->set_sell_price_4(raw_l2_tick->m_ask_unit[3].m_price / 10000.);
    l2_tick->set_sell_quantity_4(to_quantity_from_szse(raw_l2_tick->m_ask_unit[3].m_qty));
    l2_tick->set_sell_price_5(raw_l2_tick->m_ask_unit[4].m_price / 10000.);
    l2_tick->set_sell_quantity_5(to_quantity_from_szse(raw_l2_tick->m_ask_unit[4].m_qty));

    l2_tick->set_buy_price_1(raw_l2_tick->m_bid_unit[0].m_price / 10000.);
    l2_tick->set_buy_quantity_1(to_quantity_from_szse(raw_l2_tick->m_bid_unit[0].m_qty));
    l2_tick->set_buy_price_2(raw_l2_tick->m_bid_unit[1].m_price / 10000.);
    l2_tick->set_buy_quantity_2(to_quantity_from_szse(raw_l2_tick->m_bid_unit[1].m_qty));
    l2_tick->set_buy_price_3(raw_l2_tick->m_bid_unit[2].m_price / 10000.);
    l2_tick->set_buy_quantity_3(to_quantity_from_szse(raw_l2_tick->m_bid_unit[2].m_qty));
    l2_tick->set_buy_price_4(raw_l2_tick->m_bid_unit[3].m_price / 10000.);
    l2_tick->set_buy_quantity_4(to_quantity_from_szse(raw_l2_tick->m_bid_unit[3].m_qty));
    l2_tick->set_buy_price_5(raw_l2_tick->m_bid_unit[4].m_price / 10000.);
