...
TEST_CASE("Booker system correctness verification", "[Booker]")
{
    SECTION("Limit order matching with 1:1 matching")
    {
        SECTION("Sell after buy with same price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
        }
    ...
    SECTION("Limit order matching with M:N matching")
    {
        SECTION("Buy after sell with same price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).quantity() == 60);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).quantity() == 0);
        }
        ...
        SECTION("Buy after sell with same price and merged level")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 120);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
        }
        ...
        SECTION("Sell after buy with lower price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).quantity() == 60);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).quantity() == 0);
        }
        ...
        SECTION("Buy after sell with higher price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).quantity() == 0);
        ...
        SECTION("Sell after buy with step price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 20);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 20);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 20);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 20);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).quantity() == 20);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).quantity() == 0);
        }
        ...
        SECTION("Buy after sell with step price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
        }
    ...
    SECTION("Limit order with cancel")
    {
        ...
        SECTION("Limit order with cancel after partial fill")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 50);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
        }
    ...
    SECTION("Market order matching with 1:1 matching")
    {
        SECTION("Sell after buy with market price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
        }
        ...
        SECTION("Buy after sell with market price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
        }
    ...
    SECTION("Market order matching with M:N matching")
    {
        ...
        SECTION("Buy after sell with step market price")
        {
            ...
            CHECK(g_reporter->get_trade_result()[0]->bid_unique_id() == 3);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(1).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[0]->ask_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[0]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).price_1000x() == 2222);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->ask_levels().at(0).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(0).quantity() == 80);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[1]->bid_levels().at(2).quantity() == 0);
        }
    }
    ...
    SECTION("Call auction stage")
    {
        ...
        SECTION("Continuous trade after call auction")
        {
            ...
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).price_1000x() == 2222);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->ask_levels().at(0).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(0).quantity() == 40);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(1).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[2]->bid_levels().at(2).quantity() == 100);
            ...
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).price_1000x() == 2233);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).price_1000x() == 2222);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[3]->ask_levels().at(0).quantity() == 60);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(0).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(1).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[3]->bid_levels().at(2).quantity() == 0);
            ...
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(0).price_1000x() == 3322);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(0).price_1000x() == 2222);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(1).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(2).price_1000x() == 0);
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(2).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[4]->ask_levels().at(0).quantity() == 60);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(0).quantity() == 100);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(1).quantity() == 0);
            CHECK(g_reporter->get_trade_result()[4]->bid_levels().at(2).quantity() == 0);
        }
    }
}
